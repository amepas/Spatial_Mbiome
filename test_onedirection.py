import sys
from EM_intercept_inference import EM_algo, initialize_params, calc_expected_states
import numpy as np
from scipy.stats import multivariate_normal
import copy

def fitModel_1d_util(y, max_bins=8):
    """
    ...
    max_bins : int, optional
        Longest number of mixtures you want to test. The default is 8.
    Returns
    -------
    list
    ...
    for K in range(2, max_bins+1):
        ...
        for b in range(max_b):
            print(b)
            results = EM_algo(y, K)
            mixing, sigma, delta, Q, Q_edge, edge_mean, mu, likelihoods, iterations = results
